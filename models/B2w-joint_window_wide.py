"""
B2w -- Joint windowed space-time attention (wide)

As B1, but each token sees only its 3x3 patch neighbourhood, now and in every
past observation. Wide shape: d_model = 384 over 4 layers. Mean-pool readout.
...
# --------------------------------------------------------------------------
# 3. Model -- Joint windowed space-time attention (wide)
# --------------------------------------------------------------------------
